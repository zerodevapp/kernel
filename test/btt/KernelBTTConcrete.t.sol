...
// Import BTT test contracts
import {Kernel_supportsExecutionMode} from "./Kernel.supportsExecutionMode.t.sol";
import {Kernel_supportsModule} from "./Kernel.supportsModule.t.sol";
import {Kernel_isModuleInstalled} from "./Kernel.isModuleInstalled.t.sol";
import {Kernel_initialize} from "./Kernel.initialize.t.sol";
...
contract KernelBTT_Concrete_Test is
    Kernel_supportsExecutionMode,
    Kernel_supportsModule,
    Kernel_isModuleInstalled,
    Kernel_initialize,
    Kernel_setNonce,
    Kernel_setRoot,
    ...
    Kernel_viewFunctions
{
    ...
    function _initialize() internal override {
        ...
        // Install executor for executor tests
        vm.prank(address(ep));
