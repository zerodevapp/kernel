...
struct Install {
    /// @dev The module type identifier (1=validator, 2=executor, 3=fallback, 5=policy, 6=signer).
    uint256 moduleType;
...
/// @notice Stores per-validation state: installation, selector nonce, signer, and policies.
