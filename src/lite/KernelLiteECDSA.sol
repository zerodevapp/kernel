...
contract KernelLiteECDSA is KernelLite {
    ...
    function _validateUserOp(UserOperation calldata _op, bytes32 _opHash, uint256) internal override returns(uint256) {
    ...
    function _validateSignature(bytes32 _hash, bytes calldata _signature) internal view override returns(uint256) {
