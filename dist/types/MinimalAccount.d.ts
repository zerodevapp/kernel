...
export interface MinimalAccountInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "entryPoint" | "executeAndRevert" | "getNonce" | "getOwner" | "initialize" | "isValidSignature" | "onERC1155BatchReceived" | "onERC1155Received" | "onERC721Received" | "upgradeTo" | "validateUserOp"): FunctionFragment;
