...
export interface KernelInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "entryPoint" | "executeAndRevert" | "getNonce" | "getOwner" | "initialize" | "isValidSignature" | "name" | "onERC1155BatchReceived" | "onERC1155Received" | "onERC721Received" | "queryPlugin" | "upgradeTo" | "validateUserOp" | "version"): FunctionFragment;
